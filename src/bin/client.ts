...
} from "../lib/device/incoming_message.js";
...
} from "../lib/station/incoming_message.js";

const { cyan } = ansi_colors;
const commands = (Object.values(DriverCommand) as Array<string>)
  .concat(Object.values(DeviceCommand) as Array<string>)
  .concat(Object.values(StationCommand) as Array<string>)
  .concat(["quit", "exit"]);
...
const handleShutdown = (exitcode = 0): never => {

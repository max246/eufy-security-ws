...
type DeviceStateSchema1 = Modify<DeviceStateSchema0, { type: DeviceType }>;
...
export const dumpDevice = (
  ...
  const base: DeviceStateSchema0 = {
    ...
    pictureUrl: device.getPropertyValue(
  ...
  if (schemaVersion == 0) {
    base.ledStatus = device.getPropertyValue(
  ...
  device3.motionDetectionType = device.getPropertyValue(
    PropertyName.DeviceMotionDetectionType,
  ) as number;
  device3.motionTracking = device.getPropertyValue(
    PropertyName.DeviceMotionTracking,
  ) as boolean;
  device3.soundDetectionType = device.getPropertyValue(
    PropertyName.DeviceSoundDetectionType,
  ) as number;
  device3.light = device.getPropertyValue(PropertyName.DeviceLight) as boolean;
  device3.microphone = device.getPropertyValue(
    PropertyName.DeviceMicrophone,
  ) as boolean;
  device3.speaker = device.getPropertyValue(
    PropertyName.DeviceSpeaker,
  ) as boolean;
  device3.speakerVolume = device.getPropertyValue(
    PropertyName.DeviceSpeakerVolume,
  ) as number;
  device3.ringtoneVolume = device.getPropertyValue(
    PropertyName.DeviceRingtoneVolume,
  ) as number;
  device3.audioRecording = device.getPropertyValue(
    PropertyName.DeviceAudioRecording,
  ) as boolean;
  device3.powerSource = device.getPropertyValue(
    PropertyName.DevicePowerSource,
  ) as number;
  device3.powerWorkingMode = device.getPropertyValue(
    PropertyName.DevicePowerWorkingMode,
  ) as number;
  device3.recordingEndClipMotionStops = device.getPropertyValue(
    PropertyName.DeviceRecordingEndClipMotionStops,
  ) as boolean;
  device3.recordingClipLength = device.getPropertyValue(
    PropertyName.DeviceRecordingClipLength,
  ) as number;
  device3.recordingRetriggerInterval = device.getPropertyValue(
    PropertyName.DeviceRecordingRetriggerInterval,
  ) as number;
  device3.videoStreamingQuality = device.getPropertyValue(
    PropertyName.DeviceVideoStreamingQuality,
  ) as number;
  device3.videoRecordingQuality = device.getPropertyValue(
    PropertyName.DeviceVideoRecordingQuality,
  ) as number;
  device3.videoWDR = device.getPropertyValue(
    PropertyName.DeviceVideoWDR,
  ) as boolean;
  device3.lightSettingsEnable = device.getPropertyValue(
    PropertyName.DeviceLightSettingsEnable,
  ) as boolean;
  device3.lightSettingsBrightnessManual = device.getPropertyValue(
    PropertyName.DeviceLightSettingsBrightnessManual,
  ) as number;
  device3.lightSettingsBrightnessMotion = device.getPropertyValue(
    PropertyName.DeviceLightSettingsBrightnessMotion,
  ) as number;
  device3.lightSettingsBrightnessSchedule = device.getPropertyValue(
    PropertyName.DeviceLightSettingsBrightnessSchedule,
  ) as number;
  device3.lightSettingsMotionTriggered = device.getPropertyValue(
    PropertyName.DeviceLightSettingsMotionTriggered,
  ) as boolean;
  device3.lightSettingsMotionTriggeredDistance = device.getPropertyValue(
    PropertyName.DeviceLightSettingsMotionTriggeredDistance,
  ) as number;
  device3.lightSettingsMotionTriggeredTimer = device.getPropertyValue(
    PropertyName.DeviceLightSettingsMotionTriggeredTimer,
  ) as number;
  device3.chimeIndoor = device.getPropertyValue(
    PropertyName.DeviceChimeIndoor,
  ) as boolean;
  device3.chimeHomebase = device.getPropertyValue(
    PropertyName.DeviceChimeHomebase,
  ) as boolean;
  device3.chimeHomebaseRingtoneVolume = device.getPropertyValue(
    PropertyName.DeviceChimeHomebaseRingtoneVolume,
  ) as number;
  device3.chimeHomebaseRingtoneType = device.getPropertyValue(
    PropertyName.DeviceChimeHomebaseRingtoneType,
  ) as number;
  device3.notificationType = device.getPropertyValue(
    PropertyName.DeviceNotificationType,
  ) as number;
  device3.rotationSpeed = device.getPropertyValue(
    PropertyName.DeviceRotationSpeed,
  ) as number;
  device3.notificationPerson = device.getPropertyValue(
    PropertyName.DeviceNotificationPerson,
  ) as boolean;
  device3.notificationPet = device.getPropertyValue(
    PropertyName.DeviceNotificationPet,
  ) as boolean;
  device3.notificationAllOtherMotion = device.getPropertyValue(
    PropertyName.DeviceNotificationAllOtherMotion,
  ) as boolean;
  device3.notificationCrying = device.getPropertyValue(
    PropertyName.DeviceNotificationCrying,
  ) as boolean;
  device3.notificationAllSound = device.getPropertyValue(
    PropertyName.DeviceNotificationAllSound,
  ) as boolean;
  device3.notificationIntervalTime = device.getPropertyValue(
    PropertyName.DeviceNotificationIntervalTime,
  ) as boolean;
  device3.notificationRing = device.getPropertyValue(
    PropertyName.DeviceNotificationRing,
  ) as boolean;
  device3.notificationMotion = device.getPropertyValue(
    PropertyName.DeviceNotificationMotion,
  ) as boolean;
  if (schemaVersion === 3) {
    device3.motionDetectionSensivity = device.getPropertyValue(
      PropertyName.DeviceMotionDetectionSensitivity,
    ) as number;
    device3.soundDetectionSensivity = device.getPropertyValue(
  ...
  device4.chirpVolume = device.getPropertyValue(
    PropertyName.DeviceChirpVolume,
  ) as number;
  device4.chirpTone = device.getPropertyValue(
    PropertyName.DeviceChirpTone,
  ) as number;
  device4.motionDetectionSensitivity = device.getPropertyValue(
    PropertyName.DeviceMotionDetectionSensitivity,
  ) as number;
  device4.soundDetectionSensitivity = device.getPropertyValue(
    PropertyName.DeviceSoundDetectionSensitivity,
  ) as number;
  device4.videoHdr = device.getPropertyValue(
    PropertyName.DeviceVideoHDR,
  ) as boolean;
  device4.videoDistortionCorrection = device.getPropertyValue(
    PropertyName.DeviceVideoDistortionCorrection,
  ) as boolean;
  device4.videoRingRecord = device.getPropertyValue(
    PropertyName.DeviceVideoRingRecord,
  ) as number;
  device4.statusLed = device.getPropertyValue(
    PropertyName.DeviceStatusLed,
  ) as boolean;
  device4.rtspStreamUrl = device.getPropertyValue(
    PropertyName.DeviceRTSPStreamUrl,
  ) as string;
  device4.chargingStatus = device.getPropertyValue(
    PropertyName.DeviceChargingStatus,
  ) as number;
  device4.wifiSignalLevel = device.getPropertyValue(
  ...
  device5.nightvision = device.getPropertyValue(
    PropertyName.DeviceNightvision,
  ) as number;
  device5.batteryIsCharging = device.getPropertyValue(
  ...
  device6.motionDetectionRange = device.getPropertyValue(
    PropertyName.DeviceMotionDetectionRange,
  ) as boolean;
  device6.motionDetectionRangeStandardSensitivity = device.getPropertyValue(
    PropertyName.DeviceMotionDetectionRangeStandardSensitivity,
  ) as number;
  device6.motionDetectionRangeAdvancedLeftSensitivity = device.getPropertyValue(
  ...
  device6.motionDetectionTestMode = device.getPropertyValue(
    PropertyName.DeviceMotionDetectionTestMode,
  ) as boolean;
  device6.motionTrackingSensitivity = device.getPropertyValue(
    PropertyName.DeviceMotionTrackingSensitivity,
  ) as number;
  device6.motionAutoCruise = device.getPropertyValue(
    PropertyName.DeviceMotionAutoCruise,
  ) as boolean;
  device6.motionOutOfViewDetection = device.getPropertyValue(
    PropertyName.DeviceMotionOutOfViewDetection,
  ) as boolean;
  device6.lightSettingsColorTemperatureManual = device.getPropertyValue(
    PropertyName.DeviceLightSettingsColorTemperatureManual,
  ) as number;
  device6.lightSettingsColorTemperatureMotion = device.getPropertyValue(
    PropertyName.DeviceLightSettingsColorTemperatureMotion,
  ) as number;
  device6.lightSettingsColorTemperatureSchedule = device.getPropertyValue(
    PropertyName.DeviceLightSettingsColorTemperatureSchedule,
  ) as number;
  device6.lightSettingsMotionActivationMode = device.getPropertyValue(
    PropertyName.DeviceLightSettingsMotionActivationMode,
  ) as number;
  device6.videoNightvisionImageAdjustment = device.getPropertyValue(
    PropertyName.DeviceVideoNightvisionImageAdjustment,
  ) as boolean;
  device6.videoColorNightvision = device.getPropertyValue(
    PropertyName.DeviceVideoColorNightvision,
  ) as boolean;
  device6.autoCalibration = device.getPropertyValue(
  ...
  device7.lockSettingsAutoLock = device.getPropertyValue(
    PropertyName.DeviceAutoLock,
  ) as boolean;
  device7.lockSettingsAutoLockTimer = device.getPropertyValue(
    PropertyName.DeviceAutoLockTimer,
  ) as number;
  device7.lockSettingsAutoLockSchedule = device.getPropertyValue(
    PropertyName.DeviceAutoLockSchedule,
  ) as boolean;
  device7.lockSettingsAutoLockScheduleStartTime = device.getPropertyValue(
    PropertyName.DeviceAutoLockScheduleStartTime,
  ) as string;
  device7.lockSettingsAutoLockScheduleEndTime = device.getPropertyValue(
    PropertyName.DeviceAutoLockScheduleEndTime,
  ) as string;
  device7.lockSettingsOneTouchLocking = device.getPropertyValue(
    PropertyName.DeviceOneTouchLocking,
  ) as boolean;
  device7.lockSettingsWrongTryProtection = device.getPropertyValue(
    PropertyName.DeviceWrongTryProtection,
  ) as boolean;
  device7.lockSettingsWrongTryAttempts = device.getPropertyValue(
    PropertyName.DeviceWrongTryAttempts,
  ) as number;
  device7.lockSettingsWrongTryLockdownTime = device.getPropertyValue(
    PropertyName.DeviceWrongTryLockdownTime,
  ) as number;
  device7.lockSettingsScramblePasscode = device.getPropertyValue(
    PropertyName.DeviceScramblePasscode,
  ) as boolean;
  device7.lockSettingsSound = device.getPropertyValue(
    PropertyName.DeviceSound,
  ) as number;
  device7.lockSettingsNotification = device.getPropertyValue(
    PropertyName.DeviceNotification,
  ) as boolean;
  device7.lockSettingsNotificationUnlocked = device.getPropertyValue(
    PropertyName.DeviceNotificationUnlocked,
  ) as boolean;
  device7.lockSettingsNotificationLocked = device.getPropertyValue(
  ...
  device8.notificationRadarDetector = device.getPropertyValue(
    PropertyName.DeviceNotificationRadarDetector,
  ) as boolean;
  device8.continuousRecording = device.getPropertyValue(
    PropertyName.DeviceContinuousRecording,
  ) as boolean;
  device8.continuousRecordingType = device.getPropertyValue(
    PropertyName.DeviceContinuousRecordingType,
  ) as number;
  device8.loiteringDetection = device.getPropertyValue(
    PropertyName.DeviceLoiteringDetection,
  ) as boolean;
  device8.loiteringDetectionRange = device.getPropertyValue(
    PropertyName.DeviceLoiteringDetectionRange,
  ) as number;
  device8.loiteringDetectionLength = device.getPropertyValue(
    PropertyName.DeviceLoiteringDetectionLength,
  ) as number;
  device8.motionDetectionSensitivityMode = device.getPropertyValue(
    PropertyName.DeviceMotionDetectionSensitivityMode,
  ) as number;
  device8.motionDetectionSensitivityStandard = device.getPropertyValue(
    PropertyName.DeviceMotionDetectionSensitivityStandard,
  ) as number;
  device8.motionDetectionSensitivityAdvancedA = device.getPropertyValue(
    PropertyName.DeviceMotionDetectionSensitivityAdvancedA,
  ) as number;
  device8.motionDetectionSensitivityAdvancedB = device.getPropertyValue(
    PropertyName.DeviceMotionDetectionSensitivityAdvancedB,
  ) as number;
  device8.motionDetectionSensitivityAdvancedC = device.getPropertyValue(
    PropertyName.DeviceMotionDetectionSensitivityAdvancedC,
  ) as number;
  device8.motionDetectionSensitivityAdvancedD = device.getPropertyValue(
    PropertyName.DeviceMotionDetectionSensitivityAdvancedD,
  ) as number;
  device8.motionDetectionSensitivityAdvancedE = device.getPropertyValue(
    PropertyName.DeviceMotionDetectionSensitivityAdvancedE,
  ) as number;
  device8.motionDetectionSensitivityAdvancedF = device.getPropertyValue(
    PropertyName.DeviceMotionDetectionSensitivityAdvancedF,
  ) as number;
  device8.motionDetectionSensitivityAdvancedG = device.getPropertyValue(
    PropertyName.DeviceMotionDetectionSensitivityAdvancedG,
  ) as number;
  device8.motionDetectionSensitivityAdvancedH = device.getPropertyValue(
    PropertyName.DeviceMotionDetectionSensitivityAdvancedH,
  ) as number;
  device8.loiteringCustomResponsePhoneNotification = device.getPropertyValue(
    PropertyName.DeviceLoiteringCustomResponsePhoneNotification,
  ) as boolean;
  device8.loiteringCustomResponseAutoVoiceResponse = device.getPropertyValue(
  ...
  device8.loiteringCustomResponseHomeBaseNotification = device.getPropertyValue(
    PropertyName.DeviceLoiteringCustomResponseHomeBaseNotification,
  ) as boolean;
  device8.loiteringCustomResponseTimeFrom = device.getPropertyValue(
    PropertyName.DeviceLoiteringCustomResponseTimeFrom,
  ) as string;
  device8.loiteringCustomResponseTimeTo = device.getPropertyValue(
    PropertyName.DeviceLoiteringCustomResponseTimeTo,
  ) as string;
  device8.deliveryGuard = device.getPropertyValue(
    PropertyName.DeviceDeliveryGuard,
  ) as boolean;
  device8.deliveryGuardPackageGuarding = device.getPropertyValue(
  ...
  device8.deliveryGuardPackageGuardingActivatedTimeTo = device.getPropertyValue(
    PropertyName.DeviceDeliveryGuardPackageGuardingActivatedTimeTo,
  ) as string;
  device8.deliveryGuardUncollectedPackageAlert = device.getPropertyValue(
  ...
  device8.deliveryGuardPackageLiveCheckAssistance = device.getPropertyValue(
    PropertyName.DeviceDeliveryGuardPackageLiveCheckAssistance,
  ) as boolean;
  device8.dualCamWatchViewMode = device.getPropertyValue(
    PropertyName.DeviceDualCamWatchViewMode,
  ) as number;
  device8.ringAutoResponse = device.getPropertyValue(
    PropertyName.DeviceRingAutoResponse,
  ) as boolean;
  device8.ringAutoResponseVoiceResponse = device.getPropertyValue(
    PropertyName.DeviceRingAutoResponseVoiceResponse,
  ) as boolean;
  device8.ringAutoResponseVoiceResponseVoice = device.getPropertyValue(
    PropertyName.DeviceRingAutoResponseVoiceResponseVoice,
  ) as number;
  device8.ringAutoResponseTimeFrom = device.getPropertyValue(
    PropertyName.DeviceRingAutoResponseTimeFrom,
  ) as string;
  device8.ringAutoResponseTimeTo = device.getPropertyValue(
    PropertyName.DeviceRingAutoResponseTimeTo,
  ) as string;
  device8.defaultAngle = device.getPropertyValue(
    PropertyName.DeviceDefaultAngle,
  ) as boolean;
  device8.defaultAngleIdleTime = device.getPropertyValue(
    PropertyName.DeviceDefaultAngleIdleTime,
  ) as number;
  device8.soundDetectionRoundLook = device.getPropertyValue(
  ...
  device9.imageMirrored = device.getPropertyValue(

...
export const dumpDevice = (device: Device, schemaVersion: number): DeviceState => {
  ...
  device6.motionDetectionRangeAdvancedMiddleSensitivity = device.getPropertyValue(
    PropertyName.DeviceMotionDetectionRangeAdvancedMiddleSensitivity
  ) as number;
  device6.motionDetectionRangeAdvancedRightSensitivity = device.getPropertyValue(
  ...
  device8.loiteringCustomResponseAutoVoiceResponseVoice = device.getPropertyValue(
  ...
  device8.deliveryGuardPackageGuardingVoiceResponseVoice = device.getPropertyValue(
    PropertyName.DeviceDeliveryGuardPackageGuardingVoiceResponseVoice
  ) as number;
  device8.deliveryGuardPackageGuardingActivatedTimeFrom = device.getPropertyValue(
  ...
  device8.deliveryGuardUncollectedPackageAlertTimeToCheck = device.getPropertyValue(
